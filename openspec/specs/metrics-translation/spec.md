# metrics-translation Specification

## Purpose

Defines the pure translation rules from `device.Stats` (the device's
`/api/stats` JSON) into Prometheus metrics: naming, unit conversion, metric
type assignment, and coverage against the golden fixture.
